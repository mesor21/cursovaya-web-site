...
Добрый день, Евгений Альбертович!
Я из УИС-211
Вы сказали реализовать для начала классы
Можете подсказать пожалуйста что бы можно было изменить или добавить
В отдельную ветку добавил.